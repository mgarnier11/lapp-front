...
//   onAccept?: (dummyUser: DummyUser) => void;
//   onDelete?: (dummyUserId: string) => void;
//   title?: string;
// }
...
// const DummyUserDialogComponent: React.FunctionComponent<Props> = props => {
//   const classes = useStyles();
//   const { questionTemplates } = props.questionTemplatesState;

//   const [name, setName] = useState(props.dummyUser.name);
//   const [description, setDescription] = useState(
//     props.dummyUser.description
//   );
//   const [template, setTemplate] = useState(props.dummyUser.template);

//   React.useEffect(() => {
//     setName(props.dummyUser.name || '');
//     setDescription(props.dummyUser.description || '');
//     setTemplate(props.dummyUser.template || questionTemplates![0]);
//   }, [props.dummyUser]);
...
//   const beforeDelete = () => {
//     if (props.onDelete) props.onDelete(props.dummyUser.id);
//   };

//   const beforeAccept = () => {
//     if (!isDenied() && props.onAccept) {
//       props.onAccept(
//         Helper.clone(props.dummyUser, { name, description, template })
//       );
//     }
//   };
...
// export const DummyUserDialog = connect<
//   StateProps,
//   DispatchProps,
//   OwnProps,
//   RootState
// >(mapStateToProps, mapDispatchToProps, null, { forwardRef: true })(
//   DummyUserDialogComponent
// );
